...
class CommonProvider {
  ...
  companion object {
    ...
    fun loadRepoConfigFromResources(classLoader: ClassLoader, resourceName: String): RepoConfig {
      return RepoConfigParser().parse(classLoader.getResource(resourceName)!!.readText())
    }

    fun loadTextFileFromResources(classLoader: ClassLoader, fileName: String): TextFile {
