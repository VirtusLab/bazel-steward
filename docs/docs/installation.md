...
```
coursier launch org.virtuslab:bazel-steward:1.0.0 --main org.virtuslab.bazelsteward.app.Main -- --help
```
...
```
wget https://github.com/VirtusLab/bazel-steward/releases/download/v1.0.0/bazel-steward.jar
