...
```
coursier launch org.virtuslab:bazel-steward:1.5.2 --main org.virtuslab.bazelsteward.app.Main -- --help
```
...
```
wget https://github.com/VirtusLab/bazel-steward/releases/download/v1.5.2/bazel-steward.jar
